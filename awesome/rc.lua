...
-- {{{ Setting default icon size for notify-send
--  It was not set by default
--  icon_size is 40
...
function dirLookup(dir)
    ...
    for file in p:lines() do                           --Loop through all files
        ...
        --wallpapers[#wallpapers+1] = file
    end
end

dirLookup("/usr/share/backgrounds")
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        local random_number = math.random(1, 72)
        gears.wallpaper.maximized(wallpapers[random_number], s, true)
    end
end
